...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_GRAPHITE] = LAYOUT_wrapper(
      ...
      KC_Q, ________________GRAPHITE_L3_5______________,     ________________GRAPHITE_R3_5______________, KC_SCLN,
                              _______THUMB_LEFT________,     _______THUMB_RIGHT_______
    ),

    [_GRALMAK] = LAYOUT_wrapper(
      ...
      KC_Q, ________________GRALMAK_L3_5_______________,     ________________GRALMAK_R3_5_______________, KC_SCLN,
                              _______THUMB_LEFT________,     _______THUMB_RIGHT_______
    ),
    ...
    [_QWERTY] = LAYOUT_wrapper(
      ...
      KC_LCTL, ________________QWERTY_L3_5________________,     ________________QWERTY_R3_5________________, KC_SCLN,
                                 _______THUMB_LEFT________,     _______THUMB_RIGHT_______
    ),
